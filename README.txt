...
1. Какие есть виды и типы баз данных с примерами?
    ...
    - Мультимодальные (Adabas)
    - Native XML (BaseX)
    - GEO/GIS (пространственные) и специализированные (GeoMesa)
    - Event (EventStoreDB)
    - Контентные (Jackrabbit)
    - Навигационные (IMS)
2. В чём различие между Web-сервером и оболочкой, как
например NodeJS?
    Веб-сервер запускается отдельно и имеет свои интерфейсы взаимодействия с клиентской частью, а оболочка совмещает это всё и используется в лёгких проектах
